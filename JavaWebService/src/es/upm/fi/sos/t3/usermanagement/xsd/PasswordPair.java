            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PasswordPair".equals(type)){
                                ...
                                return (PasswordPair)es.upm.fi.sos.t3.usermanagement.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd","newpwd").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd","oldpwd").equals(reader.getName())){
