 ...
 */
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCourseTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd",
                                         ...
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCourse));
                                    } if (localGradeTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd",
                                                                      "grade"));
    ...
    public static class Factory{
        ...
        */
        public static CourseGrade parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CourseGrade object =
                new CourseGrade();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CourseGrade".equals(type)){
                                ...
                                return (CourseGrade)es.upm.fi.sos.t3.usermanagement.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd","course").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://usermanagement.t3.sos.fi.upm.es/xsd","grade").equals(reader.getName())){
